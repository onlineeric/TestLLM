...
# trained_model_name = "pythia-70m-finetuned-cooking_ingredients"
trained_model_name = "pythia-410m-finetuned-cooking_ingredients"
...
def tokenize_function(examples):
	tok = tokenizer(examples["title"],
				text_pair=examples["ingredients"],
